...
public class StudentTableModel extends DefaultTableModel {
	static String[] columnNames = {
			...
			"Has Authority?",
			"Has Paid?",
			"Linked Trip"}; // Column names held in the student table
	
	/**
	 * Stores all values to be used in the student table held in the GUI class.
	 */
	...
	public StudentTableModel() {
		...
		} // Adds the column names to the StudentTableModel
	}
